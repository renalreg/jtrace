...
public class UKRDCIndexManagerTest {
	...
	public void testIndexManagerUpdate() throws MpiException {
		...
		// Prepare Person 1
		Person p1 = new Person().setDateOfBirth(d1).setSurname("UPDATE").setGivenName("PAT").setNationalIdType("NHS").setNationalId("NHS0000010").setGender("1");
		...
		p2.setNationalIdType("NHS").setNationalId("NHS0000011");
		im.createOrUpdate(p2);
		assert(true);
	...
	public void testIndexManagerNew() throws MpiException {
		...
		Person p2 = new Person().setDateOfBirth(d1).setSurname("JONES").setGivenName("NICK").setNationalIdType("NHS").setNationalId("NHS0000001").setGender("1");
		p2.setPostcode("CH1 6LB").setStreet("Townfield Lane");
		...
		Person p3 = new Person().setDateOfBirth(d2).setSurname("JONES").setGivenName("NICK").setNationalIdType("NHS").setNationalId("NHS0000001").setGender("1");
		...
		p5.setNationalId("CHI0000001").setNationalIdType("CHI");
